...
__device__ inline void rlcWritePixel(cudaSurfaceObject_t surf,
                                     int x, int y,
                                     unsigned char r,
                                     unsigned char g,
                                     unsigned char b,
...
__device__ inline void rlcWritePixelF(cudaSurfaceObject_t surf,
                                      int x, int y,
...
__device__ inline uchar4 rlcReadPixel(cudaSurfaceObject_t surf,
                                      int x, int y)
{
    uchar4 pixel;
...
__device__ inline void rlcWriteFloat(cudaSurfaceObject_t surf, 
...
__device__ inline float rlcReadFloat(cudaSurfaceObject_t surf,
                                     int x, int y)
{
    float value;
...
__device__ inline void rlcWriteFloat4(cudaSurfaceObject_t surf,
                                      int x, int y, float r, float g,
...
// Read 4 float values
__device__ inline float4 rlcReadFloat4(cudaSurfaceObject_t surf,
                                       int x, int y)
{
    float4 pixel;
...
__device__ inline void rlcWritePixelSafe(cudaSurfaceObject_t surf, 
...
__device__ inline void rlcWritePixelFSafe(cudaSurfaceObject_t surf,
                                          int x, int y, int width,
                                          int height, float r, float g,
                                          float b, float a = 1.0f)
{
    if (rlcInBounds(x, y, width, height))
    {
        rlcWritePixelF(surf, x, y, r, g, b, a);
    }
}

__device__ inline void rlcWriteFloatSafe(cudaSurfaceObject_t surf,
                                         int x, int y, int width,
                                         int height, float value)
{
    if (rlcInBounds(x, y, width, height))
    {
        rlcWriteFloat(surf, x, y, value);
    }
}

__device__ inline void rlcWriteFloat4Safe(cudaSurfaceObject_t surf,
                                          int x, int y, int width,
                                          int height, float r, float g,
                                          float b, float a = 1.0f)
{
    if (rlcInBounds(x, y, width, height))
    {
        rlcWriteFloat4(surf, x, y, r, g, b, a);
    }
}
